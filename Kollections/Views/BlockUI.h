...
#define kActionSheetTitleFont           [UIFont fontWithName:@"OriyaSangamMN-Bold" size:18]
...
#define kActionSheetButtonFont          [UIFont fontWithName:@"OriyaSangamMN-Bold" size:20]
...
#define kAlertViewTitleFont             [UIFont fontWithName:@"OriyaSangamMN-Bold" size:20]
...
#define kAlertViewMessageFont           [UIFont fontWithName:@"OriyaSangamMN-Bold" size:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:@"OriyaSangamMN-Bold" size:18]
