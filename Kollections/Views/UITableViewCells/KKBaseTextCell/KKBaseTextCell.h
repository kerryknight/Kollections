...
@protocol KKBaseTextCellDelegate;

@interface KKBaseTextCell : UITableViewCell {
...
/*! 
 ...
 of would not be able to define new delegate methods (which we do in KKActivityCell).
 */
 ...
 */
@protocol KKBaseTextCellDelegate <NSObject>
@optional
