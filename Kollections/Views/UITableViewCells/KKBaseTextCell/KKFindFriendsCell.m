...
@implementation KKFindFriendsCell
@synthesize delegate;
@synthesize user;
...
#pragma mark - KKFindFriendsCell

- (void)setUser:(PFUser *)aUser {
    user = aUser;
    
    // Configure the cell
    [avatarImageView setFile:[self.user objectForKey:kKKUserProfilePicSmallKey]];
    
    // Set name 
    NSString *nameString = [self.user objectForKey:kKKUserDisplayNameKey];
    ...
    [nameButton setTitle:[self.user objectForKey:kKKUserDisplayNameKey] forState:UIControlStateNormal];
    [nameButton setTitle:[self.user objectForKey:kKKUserDisplayNameKey] forState:UIControlStateHighlighted];
