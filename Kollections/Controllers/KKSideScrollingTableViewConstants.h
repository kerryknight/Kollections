//
//  KKSideScrollingTableViewConstants.h
//  Kollections
//
...
// Padding for the Cell containing the Kollection image and title
#define kKollectionCellVerticalInnerPadding            3
#define kKollectionCellHorizontalInnerPadding          3

// Padding for the title label in an Kollection's cell
#define kKollectionTitleLabelPadding                   4
