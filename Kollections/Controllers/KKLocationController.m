...
#import "KKLocationController.h"

static KKLocationController *sharedInstance = nil;

@interface KKLocationController ()
@property (nonatomic, strong) CLLocationManager *locationManager;
@property (nonatomic, strong) CLGeocoder *geocoder;
@end

@implementation KKLocationController
...
+ (KKLocationController *)sharedInstance
{
    @synchronized(self)
    {
        if (sharedInstance == nil)
			sharedInstance = [[KKLocationController alloc] init];
    }
